...
python3 dataset.py --num 256 --outfile data/toxic/256_toxic.csv --task t
...
python3 dataset.py --num 256 --outfile data/engaging/256_engaging.csv --task e
...
python3 dataset.py --num 256 --outfile data/fact/256_fact.csv --task f
